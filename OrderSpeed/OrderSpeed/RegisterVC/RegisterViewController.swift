...
class RegisterViewController: MainViewController {
    ...
    func createDictionaryAndRegister(_ uid:String) {
        ...
        let registerDic:[String : Any] = ["uid":uid, "email":tfEmail.text ?? "","user_name":userName, "queryable":queryable, "first_name":"", "last_name":"", "job_title":"", "department":"", "organization":"", "phone_number":tfPhone.text ?? "", "avatar":"", "isEnable":true]
    ...
    func saveUserAfterLogin(_ dict:[String:Any]) {
        ...
        let user = UserBeer(id: dict["uid"] as? String ?? "", roleid: "", email: dict["email"] as? String ?? "", fullname: dict["user_name"] as? String ?? "", avatar: sAvartar, phoneNumber: dict["phone_number"] as? String ?? "", tokenAPN: "")
        user.showInfo()
